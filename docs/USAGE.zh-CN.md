...
3. 卡内可切换 **逐句对照**（一行英文一行中文）、**重点词对应**、**结合上下句**、**自适应宽度**；底部还能继续 **追问** 让 AI 解释 / 举例。
4. **Enter** 翻到下一句、**Shift+Enter** 上一句，连续读完整页 / 整篇；按 **/** 把光标移进卡底「追问」框（Enter 已用于切句）；**Esc** 关掉卡片后该句仍标为「在读高亮」，可继续切句。
