...
- [2. 常见场景](#2-常见场景)
  ...
  - [2.12 通过 WEB 模式使用 ChatGPT 或 DeepSeek](#212-通过-web-模式使用-chatgpt-或-deepseek)
- [3. 功能手册](#3-功能手册)
  - [3.1 模型预设](#31-模型预设)
...
### 2.12 通过 WEB 模式使用 ChatGPT 或 DeepSeek
...
3. 重启 Zotero，在输入框底栏选择 **WEB**，选择 **ChatGPT** 或 **DeepSeek**，再点**账号**。
...
| 控件 | API 模式 | WEB 模式 |
|---|---|---|
| 发送目标 | Zotero 中配置的模型预设 | ChatGPT、DeepSeek 或自定义 ChatGPT-like 网页 |
...
- **服务菜单**：切换 ChatGPT、DeepSeek 和已保存的自定义站点。最后的“管理第三方网页…”只打开 URL 管理，并恢复此前选中的服务。
