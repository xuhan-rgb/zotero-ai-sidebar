...
<section class="panel"><h2>导入网页回答</h2><textarea id="answer" placeholder="从 ChatGPT、DeepSeek、ChatGLM、Z.ai 或 Kimi 网页复制完整回答后粘贴到这里"></textarea><div class="actions"><button id="paste">从剪贴板粘贴</button><button class="import" id="import">导回 Zotero</button><span class="status" id="status"></span></div></section></main>
<script>const task=${data};const names={chatgpt:"ChatGPT Web",deepseek:"DeepSeek Web",chatglm:"ChatGLM Web",zai:"Z.ai Web",kimi:"Kimi Web"};const urls={chatgpt:"https://chatgpt.com/",deepseek:"https://chat.deepseek.com/",chatglm:"https://chatglm.cn/main/alltoolsdetail?lang=zh",zai:"https://chat.z.ai/",kimi:"https://www.kimi.com/"};const provider=document.getElementById("provider"),source=document.getElementById("source"),prompt=document.getElementById("prompt"),answer=document.getElementById("answer"),status=document.getElementById("status"),copy=document.getElementById("copy"),copyOpen=document.getElementById("copyOpen"),paste=document.getElementById("paste"),importButton=document.getElementById("import");
